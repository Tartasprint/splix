...
export function initServerSelection() {
    ...
    selected_server = [
		...
		{"displayName":"US East","endpoint":"wss://nyc3.splix.io/1","playerCount":27,"official":true,"recommended":true}][3];
}

export function getSelectedServer() {
	// deno-lint-ignore no-constant-condition
	return false ? selected_server.endpoint : "ws://localhost:8080/gameserver";
}